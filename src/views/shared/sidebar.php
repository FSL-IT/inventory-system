...
<nav class="sidebar" id="sidebar">
    ...
    <div class="sidebar-nav" id="sidebar_nav">
        ...
        <a class="nav-item"
                href="/src/views/process_owners.php"
        ...
        <a class="nav-item"
                href="/src/views/admin/users.php"
                id="nav-users">
            <span class="nav-item__icon">
        ...
        <a class="nav-item"
                href="/src/views/admin/backup.php"
                id="nav-backup">
            <span class="nav-item__icon">
